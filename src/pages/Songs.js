...
import { FaCheck, FaCopy, FaInstagram } from "react-icons/fa";
...
const Songs = () => {
    const audiaSongs = [
        {
            ...
            contentUrl:
                "https://soundcloud.com/houston-ghanaian-sda/dr-clerk-houston-ghana-sda",
    ...
    return (
        <CustomContainer
            fluid
            sectionClass="media-songs-audio"
        ...
        >
            ...
            <Row className="row-gap-3 mt-3">
                {audiaSongs.map((data) => (
                    <Col sm={6} lg={3} className="d-flex" key={data.id}>
